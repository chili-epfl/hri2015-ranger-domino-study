...
\begin{figure}[ht!] 
    \centering 
    \includegraphics[width=0.8\columnwidth]{domino-setup.pdf} 
...
immediately interpreted as failures, we introduce these misbehaviours neither at
...
behaviour toward the robot} (\ie the child-robot interactions) have been
captured in the video recordings by annotating a set of actions, described
below. Children's \textbf{phenomenological perception of the robot} has been
captured through two audio-recorded semi-structured interviews which took place
between run \emph{1.5} and \emph{2.1} and at the end of the experiment. A
short preliminary interview was also conducted to explain the game and assess
the expectations of the children toward the robot.
...
\begin{figure}[t]
    ...
    \caption{\small \textbf{Anthropomorphic perception of the robot versus
        ...
        actions (without \emph{explore}) and the \textit{anthropomorphic
        ...
        account the behavioural aspect of the anthropomorphism index, as this is
